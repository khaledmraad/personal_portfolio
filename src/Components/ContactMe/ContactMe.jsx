...
export default function ContactMe() {
  ...
  return (
    <React.Fragment>
        ...
        <button onClick={handleClickOpen} type="button" class="px-6 py-3.5 text-base font-medium text-[#ffffff] inline-flex items-center bg-blue hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
>
        ...
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Send Email</h2>
      <form action="#" class="space-y-8">
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-[#ffffff] rounded-lg bg-green sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
      </form>
        </DialogContent>
        <DialogActions>
